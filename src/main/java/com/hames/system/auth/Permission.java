...
public enum Permission {
	 ...
	 *LEAD 
	 */
	VIEW_LEAD("View Lead","lead:view"),
	CREATE_LEAD("Create Lead","lead:create"),
	
	/**
	 * CLIENT
	 */
	VIEW_CLIENT("View Client","client:view"),
	CREATE_CLIENT("Create Client","client:create"),
	
	/**
	 *PROJECT 
	 */
	VIEW_PROJECT_DETAILS("View Project Details","project:details:view"),
	CREATE_PROJECT("Create Project","project:create"),
	
	/**
	 * TASK
	 */
	VIEW_TASK_DETAILS("View Task Details","task:details:view"),
	CREATE_TASK("Create Task","task:create"),
